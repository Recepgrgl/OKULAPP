    ...
    public partial class frmOgrBul : Form
    {
        ...
        private void btnBul_Click(object sender, EventArgs e)
        {
            ...
            if (ogr!=null)
            {
                ...
                // Öğrenci bulunduğunda Sil ve Güncelle butonlarını aktif yap
                frm.btnSil.Enabled = true;
                frm.btnGuncelle.Enabled = true;

                // Öğrenci bulunduğunda bul formunu kapat
                this.Close();
            }
            else
            {
                // Öğrenci bulunamadığında Sil ve Güncelle butonlarını pasif yap
